    ...
    <form v-else class="flex flex-col gap-4" @submit.prevent="handleSubmit">
      ...
      <div class="grid grid-cols-12 gap-3">
        <div class="col-span-4 flex flex-col gap-1">
          <label for="expenseDetailCurrency" class="text-sm font-medium">Moeda</label>
          <Select
        ...
        <div class="col-span-8 flex flex-col gap-1">
          <label for="expenseDetailAmount" class="text-sm font-medium">Valor</label>
          <InputNumber
      ...
      <div class="flex flex-col gap-1">
        <label for="expenseDetailAccount" class="text-sm font-medium">Conta</label>
        <Select
      ...
      <div class="flex flex-col gap-1">
        <label for="expenseDetailCategory" class="text-sm font-medium">Categoria</label>
        <Select
      ...
      <div class="flex flex-col gap-1 max-w-[14rem]">
        <label for="expenseDetailStatus" class="text-sm font-medium">Situação</label>
        <Select
