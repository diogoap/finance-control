    ...
    event.waitUntil(
        ...
        caches
            ...
            */
            ...
            .then(function () {
                console.log('WORKER: install completed. Version: ' + version);
            })
    );
});
            ...
            */
            ...
            .then(function (cached) {
                /* Even if the response is in our cache, we go to the network as well.
                   ...
                   a network response and store that in the cache. Read more:
                ...
                return Promise.all(
                    keys
                        ...
                        .map(function (key) {
                            ...
                            */
                            if (trace) {
                                console.log('WORKER: removing old cache entry: ' + key);
                            }
