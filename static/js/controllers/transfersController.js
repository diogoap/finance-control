...
app.controller('transfersController', function($scope, $http, $uibModal, $locale, uiGridConstants, Utils, Transfers) {
 	...
 	$scope.columns = [
        ...
        { name: 'Data', field: 'date', type: 'date', width: Utils.getSizeRes('12%', '17%', '17%'), enableColumnMenu: false,
        ...
        { name: 'Valor', field: 'amount', type: 'number',  width: Utils.getSizeRes('12%', '17%', '17%'), enableColumnMenu: false,
        ...
        {
            name: 'Conta Origem', field: '_accountOrigin.name', type: 'string', width: Utils.getSizeRes('33%', '33%', '33%'), enableColumnMenu: false
        },
        { name: 'Conta Destino', field: '_accountTarget.name', type: 'string', width: Utils.getSizeRes('33%', '33%', '33%'), enableColumnMenu: false }
    ];
